    ...
    return (
        <AppBar position="sticky">
            <Toolbar disableGutters sx={{height:"10vh",backgroundColor:"white"}}>
                ...
                <Box sx={{ flexGrow: 1, display: { xs: 'flex', md: 'none' } }}>
                    ...
                    >
                        ...
                        {nav_content.map((item) => (
                            <MenuItem key={item} onMouseOver={handleOpenMenu(item)}>
                                {item}
                            </MenuItem>
                        ))}
                    </Menu>
                ...
                <Box sx={{  display: { xs: 'none', md: 'flex' },marginLeft:{xl:"11rem"},borderRight:"1px solid #f3f7f9 " }}>
                    {nav_content.map((item) => (
                        <Button
                            ...
                            aria-haspopup="true"
                            onMouseOver={handleOpenMenu(item)}
                            sx={{ mx: 1, color: 'black',fontFamily:"poppins",fontWeight:"700", '&:hover':{color:"red"}}}
                        >
                            {item}
                        </Button>
                    ))}
                ...
                <Box>
                    {/*------------------------- search box -------------------------*/}
                   <Box>
                   <Box onClick={handleClick} sx={{borderRadius:"50%",width:"30px",height:"30px",border:"1px solid black",textAlign:"center",marginLeft:"2rem",color:"black",'&:hover':{backgroundColor:"red" ,borderColor:"red",color:"white",transitionDuration:".5s"}}} > <SearchIcon />  </Box>
      <Popover
        id={id}
        open={open}
        anchorEl={anchorEl}
     ...
     sx={{marginTop:"25px",}}
      >
        ...
        <Box sx={{height:{xl:"70px"},width:{xl:"20rem"},display:{xl:"flex"},alignItems:"center"}}>
            <input type="text" placeholder='Type Word Then Enter' style={{padding:"9px 15px 9px 15px",backgroundColor:"#f5faff",border:"none"}}/><Button type='submit' style={{backgroundColor:"red",height:"30px"}}>< SearchIcon/></Button>
            </Box>
                ...
                <Box sx={{display:{xl:"flex",xs:"none" }}}>
                   <Box sx={{borderRadius:"50%",width:"30px",height:"30px",border:"1px solid black",textAlign:"center",marginLeft:"10px",color:"black",
                '&:hover':{backgroundColor:"black",color:"white",transitionDuration:".5s"}
                }}>< ProductionQuantityLimitsIcon/></Box>


                    <Box sx={{height:"30px",width:"130px",border:"1px solid black",display:"flex",alignItems:"center",justifyContent:"center",marginLeft:"2rem",color:"black",
                    '&:hover':{backgroundColor:"black",color:"white",transitionDuration:".5s"}
                
                }} className="box"><Typography style={{fontFamily:"poppins",fontSize:'12px',fontWeight:"500"}} >GET START NOW!</Typography></Box>
                   </Box> 
            </Toolbar>
        </AppBar>
    );
